...
NATIONAL_FINES = {
    ...
    "signal_jump":             {"description": "Signal Jumping / Red Light",      "fine": 5000,  "imprisonment": None,       "section": "130"},
    ...
    "overloading_goods":       {"description": "Goods Overloading (₹20,000 first offence + ₹2,000 per extra tonne)", "fine": 20000, "imprisonment": None,       "section": "194"},
...
with tab2:
    ...
    laws = [
        ...
        ("Section 130", "Driving Against Signal", "Driving against a red light signal — first offence fine ₹5,000."),
        ("Section 194", "Overloading", "Goods vehicle overloading — fine ₹20,000 for first offence + ₹2,000 per extra tonne."),
